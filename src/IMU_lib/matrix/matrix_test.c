...
void testMatrix(void) {
    ...
    int boolr = gluInvertMatrix4x4(INV, INV_dest);
    showmat(INV_dest, (char *)"\nThe inverse of matrix:");
    printf("\n bool = %d \n\n", boolr);

    inverseMatrix_uni(INV, INV_dest);
    showmat(INV_dest, (char *)"\nThe inverse of univarsal:");
...
//    A*B = C: [3:3]
//    [     11.0000     8.0000      -15.0000
//          13.0000     34.0000     -30.0000
//          -12.0000	-46.0000	35.0000	]
